...
export default function InjectableAntibiotic() {
  return (
    <section className="py-16 px-4 bg-white relative">
      {/* Heading */}
      <div className="max-w-6xl mx-auto text-center mb-8">
        <h2 className="text-3xl font-bold mb-2">INJECTABLE (ANTIBIOTIC)</h2>
        <Divider />
      </div>
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        >
          {products
            .filter((product) => product.category === "injectable-antibiotic")
            .map((product) => (
