...
export default function TestCardsProducts() {
  return (
    <section className="py-16 px-4 bg-white relative">
      {/* Heading */}
      <div className="max-w-6xl mx-auto text-center mb-8">
        <h2 className="text-3xl font-bold mb-2">Test Card & Test Strips</h2>
        <Divider />
      </div>
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        >
          {products
            .filter((product) => product.category === "test-card")
            .map((product) => (
      ...
      <div className="mt-8 text-center">
        <Link href="/products?category=test-card">
